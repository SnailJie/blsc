...
function popreview()
{
document.preview.title.value=document.myform.title.value;
document.preview.content.value=document.myform.content.value;
var popupWin = window.open('add.asp?action=preview', 'preview_page', 'scrollbars=yes,width=550,height=450');
