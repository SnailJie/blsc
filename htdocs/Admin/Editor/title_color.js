...
var width1=1;      //define the width of the color bar here (for forum with little width put 1)
...
{
myform.title.style.color=MyString;
myform.titlecolor.value=MyString;
}
...
function rgb(pas,w,h){
	for (j=0;j<6+1;j++){
		for (i=0;i<pas+1;i++){
		  ...
		  codehex = r + '' + g + '' + b;
		  document.write('<td bgColor=\"' + RGB2Hexa(r,g,b) + '\" onClick=\"insertTag(this.bgColor);lightCase(this,\'ColorUsed\');\" width=\"'+w+'\" height=\"'+h+'\"><IMG height='+h+' width='+w+' border=0 title=\"<FONT COLOR='+RGB2Hexa(r,g,b)+'>标题颜色：'+RGB2Hexa(r,g,b)+'</FONT>\"></TD>\n');
		}
	}
}
